...
Ons werd de taak opgelegt door onze opdracht gever Michiel Noback of wij het verschil in handgrote tussen de sexe man en vrouw konden berekenen. In dit document zijn wij doormiddel van een template hier mee bezig geweest. Er zijn grafieken en tabellen te vinden met de bijpassende uitleg en observaties. 
...
ggplot(data = biometric_data,
       mapping = aes(x = "laborant id", y = "handlengte in mm", fill = lab_as_string)) + 
