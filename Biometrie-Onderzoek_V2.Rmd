...
Ons werd de taak opgelegd door onze opdracht gever Michiel Noback of wij het verschil in handgrote tussen de sexe man en vrouw konden berekenen. In dit document zijn wij doorn middel van een template hiermee bezig geweest. Er zijn grafieken en tabellen te vinden met de bijpassende uitleg en observaties. 
...
De data is opverdeeld in 6 kollomen. 
...
1. Wat gebeurt er met de vorm van de verdeling als `n` groter wordt?\
   A: De vorm is steeds meer even en lijkt op een hele egale normaalverdeling
2. Wat gebeurt er met de spreiding van de data (x-as) als `n` groter wordt, en kan je dat verklaren?\
    A: Als N groter wordt, wordt de spreiding van de x as ook groter. N is steekproefgroote wanneer deze        groter is geeft dit meer resultaten waar meer verschillen in kunnen zitten dus krijg je een              bredere x as
